package com.github.tinkerti.sqltest.stetho;
...
public class TMDbFilesDumperPlugin implements DumperPlugin {
    private static final String NAME = "rongDbFile";

    private final Context mContext;
    private final DatabaseFilesProvider mDatabaseFilesProvider;

    public TMDbFilesDumperPlugin(Context context, DatabaseFilesProvider databaseFilesProvider) {
        mContext = context;
